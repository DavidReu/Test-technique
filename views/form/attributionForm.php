    ...
    <div class="row d-flex align-items-center justify-content-center">
        <form class="col-md-6" method="POST" name="myForm">
            <div class="px-5 py-3 formRegister">
                ...
                <div class="form-input my-2"><input type="date" class="form-control" placeholder="Date" name="date" required> </div>
                <label class="mt-2" for="time_slot_start">Indiquez l'heure de début :</label>
                <div class="form-input my-2"><input type="time" class="form-control" name="time_slot_start" required> </div>
                <label class="mt-2" for="time_slot_end">Indiquez l'heure de fin :</label>
                <div class="form-input my-2"><input type="time" class="form-control" name="time_slot_end" required> </div>
                <label class="mt-2" for="user">Sélectionnez un utilisateur :</label>
                <div class="my-2"><select class="form-select" aria-label="Default select example" name="user">
                ...
                <div class="my-2"><select class="form-select" aria-label="Default select example" name="computer">
                ...
                <div class="mt-3 text-center">
                    <input type="submit" class="btn btn-primary col-3 rounded-pill" value="Attribuer" name="attribuer">
                </div>
            </div>
        </form>
    </div>
