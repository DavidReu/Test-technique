<div class="container-fluid d-flex justify-content-center mt-5">
    <form method="post" action="" class="form d-flex flex-column align-items-center w-50">
        <input class="w-50 my-1" type="mail" placeholder="Votre mail" name="mail" required>
